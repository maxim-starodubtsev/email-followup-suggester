...
describe("DIAL API URL Construction", () => {
  ...
  it("should construct correct DIAL API URL with deployment and API version", async () => {
    ...
    const expectedUrl =
      "https://ai-proxy.lab.epam.com/openai/deployments/gpt-4.1-2025-04-14/chat/completions?api-version=2025-04-14";
  ...
  it("should handle different deployment names", async () => {
    ...
    const expectedUrl =
      "https://ai-proxy.lab.epam.com/openai/deployments/custom-deployment-name/chat/completions?api-version=2024-08-01";
  ...
  it("should fallback to model name when deployment name is not specified", async () => {
    ...
    const expectedUrl =
      "https://ai-proxy.lab.epam.com/openai/deployments/fallback-model/chat/completions?api-version=2025-04-14";
