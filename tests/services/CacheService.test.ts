...
describe('CacheService', () => {
    ...
    describe('Eviction Policies', () => {
        ...
        it('should evict using LFU policy', () => {
            ...
            const remainingKeys = ['key2', 'key3', 'key4'].filter(key => lfuCache.has(key));
    ...
    describe('Cache Export/Import', () => {
        ...
        it('should validate entries during import', () => {
            ...
            const invalidData: any[] = [
                { key: 'invalid', entry: { data: 'test', timestamp: 0, ttl: 0, accessCount: 0, lastAccessed: 0, size: 0, hash: '' } }, // Invalid structure
